...
export default class Sketch {
  constructor() {
    ...
    this.imageOther = this.container.getAttribute('data-imageOther');
  ...
  start(images) {
    ...
    let u_image2Location = this.gl.getUniformLocation(this.program, 'image2');

    // set which texture units to render with.
    this.gl.uniform1i(u_image0Location, 0); // texture unit 0
    this.gl.uniform1i(u_image1Location, 1); // texture unit 1

    this.gl.uniform1i(u_image2Location, 2); // texture unit 2
