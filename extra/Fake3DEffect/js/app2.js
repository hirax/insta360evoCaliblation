! function(t) {
    ...
    function i(a) {
      ...
      return t[a].call(n.exports, n, n
          .exports, i), n.l = !0,
        n.exports
    }
    i.m = t, i.c = e, i.d = function(t,
      e, a) {
      i.o(t, e) || Object
        .defineProperty(t, e, {
          enumerable: !0,
    ...
    var s = new(r(i(3)).default.GyroNorm),
      l = function() {
        function t() {
          ...
          this.imageOther = this.container.getAttribute("data-imageOther"),  // 追加(jun)
          
          this.vth = this.container.getAttribute("data-verticalThreshold"), 
          this.hth = this.container.getAttribute("data-horizontalThreshold"),
          
          this.imageURLs = [this.imageOriginal, this.imageDepth, this.imageOther],  // 追加(jun)
          this.textures = [], 
        ...
        return a(t, [{
          ...
          value: function(t) {
            ...
            var n = this.gl.getUniformLocation(this.program, "image0"),
                ...
                // jun
                n2 = this.gl.getUniformLocation(this.program, "image2");

            this.gl.uniform1i(n, 0), 
            this.gl.uniform1i(o, 1), 
            // jun
            this.gl.uniform1i(n2, 2), 
    ...
    function m(t, e, i) {
      return t == t && (void 0 !== i && (t = t <= i ? t : i), void 0 !== e && (t = t >= e ?
        t : e)), t
    }
    e.default = l, h.prototype
      .set = function() {
        for (var t =
            "uniform" +
            this.suffix,
...
void main() {
           ...
           // jun
           vec4 tex0 = texture2D(image0,mirrored(fake3d));
           vec4 tex2 = texture2D(image2,mirrored(fake3d));         // jun
           vec4 tex = (tex0*(0.5-mouse.x) + tex2*(0.5+mouse.x));   // jun
           //vec4 tex0 = texture2D(image2,mirrored(fake3d));
              ...
              function() {
                ...
                return function(
                  ...
                  0 ? (e = Math
                    ...
                    t[
                      8] < 0 ? (e = Math.atan2(t[1], -t[4]), i = -Math.asin(t[7]), i += i >=
                      0 ?
                      -
                      r :
                      r,
                    ...
                    t[
                      6] < 0 ? (e = Math.atan2(t[1], -t[4]), i = -Math.asin(t[7]), i += i >=
                      0 ?
                      -
                      r :
                      r,
              ...
              var o =
                function(
                  ...
                  return !
                    ...
                    +
                    e
                    .webkitCompassAccuracy < 50 && (this.alphaOffsetDevice = new y.Euler(e.webkitCompassHeading, 0, 0), this.alphaOffsetDevice.rotateZ(d), this.alphaOffsetScreen = d, ++a >=
                      10
                    ) ?
                    void t
                    .removeEventListener(
              ...
              return function() {
                ...
                return this
                  ...
                  (e.setFromEuler(
                    ...
                    t
                    .alpha < 0 && (t.alpha += 360), t.alpha %= 360, n -= t.alpha), t.set(n, a.beta, a.gamma), i.setFromEuler(t), i
              }
            }(),
